const translations = {
  zh: {
    ...
    noteQuarantine: "首次打开若提示「已损坏」，运行一条命令即可解除",
    noteAccessibility: "「粘贴回原 App」需要在系统设置中授权一次辅助功能",
    noteLink: "查看安装步骤",
    copyCommand: "复制命令",
    commandCopied: "已复制",
  ...
  en: {
    ...
    learnFeatures: "See all features",
    ...
    noteQuarantine: "If macOS calls aPaste \"damaged\" on first launch, one command clears it",
    noteAccessibility: "Pasting back into your previous app needs a one-time Accessibility permission",
    noteLink: "See the install steps",
